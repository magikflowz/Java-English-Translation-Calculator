    ...
    boolean Counter = true;  //Counter for the while loop
        ...
        while(Counter){  //This while loop keeps the program running and doesn't break till enters q for Option
            ...
            switch(Option){
                ...
                System.out.println(EnglishConversion[NumberOne]+"Divided by "+EnglishConversion[NumberTwo] + " Sum is " + Division(NumberOne, NumberTwo));
                keyboard.nextLine();
                ...
                //passes the number variables into englishConversion array and converts them into a message based of the array list 
                System.out.println(EnglishConversion[NumberOne]+" exponential of "+EnglishConversion[NumberTwo] + " Sum is " + Math.pow(NumberOne, NumberTwo));
                keyboard.nextLine();
