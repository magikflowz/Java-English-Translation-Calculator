...
public class Calculator{
    ...
    public static int LengthChecker(double NumberOne, double NumberTwo){

        int Length = String.valueOf(NumberOne); //Lines 63 -71 converts the double into a string and checks the length of the string 
        int String Length.length()
