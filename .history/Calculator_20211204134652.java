    ...
    boolean Counter = true;  //Counter for the while loop
        ...
        while(Counter){  //This while loop keeps the program running and doesn't break till enters q for Option
            ...
            switch(Option){
                ...
                //Inputing NumberOne and NumberTwo and then passing into the length checker
                ...
                //passes the number var into englishConversion array and converts them into a message based of the array list 
