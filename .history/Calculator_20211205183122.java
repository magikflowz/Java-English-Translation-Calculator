...
public class Calculator{
    ...
    public static void Integer Division(Integer intNumberOne, Integer intNumberTwo){ //Division method takes int NumberOne and int NumberTwo as arguments

        
        try {
            System.out.println(intNumberOne / intNumberTwo); // throw Exception
        }
