...
public class Calculator{
    ...
    public Integer Division(Integer intNumberOne, Integer intNumberTwo){ //Division method takes int NumberOne and int NumberTwo as arguments

        
        try {
            return System.out.println(intNumberOne / intNumberTwo); // throw Exception
        }
