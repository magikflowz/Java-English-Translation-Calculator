    ...
    boolean Counter = true;  //Counter for the while loop
        ...
        while(true){
            ...
            switch(Option){
                ...
                case '-':
                System.out.println("Enter a number you would like to subtract: ");
                NumberOne = keyboard.nextDouble();
                System.out.println("Enter a second number you like to subtract: ");
                NumberTwo = keyboard.nextDouble();
                Subtraction(NumberOne, NumberTwo);

                case '*':
                System.out.println("Enter a number you like to Multiply: ");
                NumberOne = keyboard.nextDouble();
                System.out.println("Enter a second number you like to Multiply: ");
                NumberTwo = keyboard.nextDouble();
                Multiply(NumberOne, NumberTwo);
                break;

                case '/':
                System.out.println("Enter a number you like to divide: ");
                NumberOne = keyboard.nextDouble();
                System.out.println("Enter a second number you you like to divide: ");
                NumberTwo = keyboard.nextDouble();
                Division(NumberOne, NumberTwo);

                case '^':
                System.out.println("Enter a number you like to be your base: ");
                NumberOne = keyboard.nextDouble();
                System.out.println("Enter a second number that you would to be your exponent: ");
                NumberTwo = keyboard.nextDouble();
                exponent(NumberOne, NumberTwo);
